            ...
            <div class=" row">
                <div class="col-md-12">
                    <div class="page-header">
                        ...
                        <br/>
                        <br/>
                        <h2 style="text-align: center">Liste Poule</h2>
                    </div>
...
<br/>
                    ...
                    echo "<table  class='lignesEspacees'  >";
                        ...
                        echo "<tr>";
                            echo "<td >" . mb_strtoupper($row['pouleA']) . "</td>";
                            echo "<td >" . mb_strtoupper($row['pouleB']) . "</td>";
                            echo "<td >" . mb_strtoupper($row['pouleC']) . "</td>";
                            echo "<td>" . mb_strtoupper($row['pouleD']) . "</td>";
                        echo "</tr>";
