                    ...
                    <div class="col-md-12">
                            ...
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        echo "<html>";
                                        echo "<body>";
                                        echo "<select name='pouleA' class='form-control'>";
                                        echo '<option>';
                                        echo '</option>';
                                        $select_attribute = '';
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                echo "<html>";
                                echo "<body>";
                                echo "<select name='pouleB' class='form-control'>";
                                echo '<option>';
                                echo '</option>';
                                // $select_attribute = '';
                                while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                echo "<html>";
                                echo "<body>";
                                echo "<select name='pouleC' class='form-control'>";
                                echo '<option>';
                                echo '</option>';
                                $select_attribute = '';
                                while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                echo "<html>";
                                echo "<body>";
                                echo "<select name='pouleD' class='form-control'>";
                                echo '<option>';
                                echo '</option>';
