...
<head>
    ...
    <!-- jQuery (necessary for Bootstrap's JavaScript ugins) -->
    <meta charset="utf-8">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="alert alert-danger fade in">
                        <p>Désolé, vous avez fait une demande invalide. SVP <a href="listeLicence.php" class="alert-link">revenir en arrière </a> et réessayer.</p>
                    </div>
                </div>
            </div>
        </div>
